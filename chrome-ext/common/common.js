...
const defaultUrlPattern = `https?:\\/\\/jenkins-main\\.octane\\.admlabs\\.aws\\.swinfra\\.net\\/\\S*job\\/`;
const defaultMyName = '';
const defaultHighlightNames = '';
const defaultCommitUrlPrefix = `https://hmf.gitlab.otxlab.net/adm-sdp/MQM/mqm/-/commit/`;
